...
① Region Proposal과 Classification, Box Regression을 한번에 수행하는 1stage detector 

② 하나의 네트워크가 전체 이미지에서 bounding box를 찾고, 그 박스에 대한 class 확률도 계산 
...
Grid cell이 필요한 이유 \([http://machinethink.net/blog/object-detection/](http://machinethink.net/blog/object-detection/)\)  
